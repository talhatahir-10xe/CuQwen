...
int main(int argc, char** argv) {
    std::cout << "=============================================================" << std::endl;
    std::cout << "            CUQWEN: CUDA Chat Engine (Qwen2.5 1.5B)          " << std::endl;
    std::cout << "=============================================================\n" << std::endl;
    ...
    while (true) {
        ...
        for (size_t i = 0; i < prompt_tokens.size(); ++i) {
            ...
            next_token = qwen_forward(tok, current_pos, config, state, weights, handle);
            current_pos++;
        }
        ...
        // Display updated performance stats including context window metrics
